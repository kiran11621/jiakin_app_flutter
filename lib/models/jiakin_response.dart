...
//
//     final jiakinResponse = jiakinResponseFromJson(jsonString);

import 'dart:convert';

JiakinResponse jiakinResponseFromJson(String str) =>
    JiakinResponse.fromJson(json.decode(str));

String jiakinResponseToJson(JiakinResponse data) => json.encode(data.toJson());

class JiakinResponse {
  ...
  factory JiakinResponse.fromJson(Map<String, dynamic> json) => JiakinResponse(
